...
library(lme4)
reg_meu = lmer(resp~pc+ (1+pc| county)+ (1|time) ,
               data = panel)
summary(reg_meu)
confint(reg_meu,method="Wald")

reg_mes = lmer(resp~pc+urb+ed+medct+fem+blk+his+unemp+poll+pov+hobed+mcare+obese+tob+spec + (1+pc| county)+ (1|time) ,
               data = panel)
summary(reg_mes)
...
reg_mel = lmer(resp~lagpc1+urb+ed+medct+fem+blk+his+unemp+poll+pov+hobed+mcare+obese+tob+spec + (1+lagpc1| county)+ (1|time) ,
               data = dd)
summary(reg_mel)
...
reg_mef = lmer(resp~fp+urb+ed+medct+fem+blk+his+unemp+poll+pov+hobed+mcare+obese+tob+spec + (1+pc| county)+ (1|time) ,
               data = panel)
summary(reg_mef)
...
reg_meg = lmer(resp~gim+urb+ed+medct+fem+blk+his+unemp+poll+pov+hobed+mcare+obese+tob+spec + (1+pc| county)+ (1|time) ,
               data = panel)
summary(reg_meg)
...
reg_meu = lmer(resp~pc+urb+ed+medct+fem+blk+his+unemp+poll+pov+hobed+mcare+obese+tob+spec + (1+pc| county)+ (1|time) ,
               data = panelurb)
summary(reg_meu)
confint(reg_meu,method="Wald")

panelrur = panel[panel$urb==0,]
reg_mer = lmer(resp~pc+urb+ed+medct+fem+blk+his+unemp+poll+pov+hobed+mcare+obese+tob+spec + (1+pc| county)+ (1|time) ,
               data = panelrur)
summary(reg_mer)
...
reg_melp = lmer(resp~pc+urb+ed+medct+fem+blk+his+unemp+poll+pov+hobed+mcare+obese+tob+spec + (1+pc| county)+ (1|time) ,
                data = panellopov)
summary(reg_melp)
confint(reg_melp,method="Wald")

panelhipov = panel[panel$pov>(-0.1584),]
reg_mehp = lmer(resp~pc+urb+ed+medct+fem+blk+his+unemp+poll+pov+hobed+mcare+obese+tob+spec + (1+pc| county)+ (1|time) ,
                data = panelhipov)
summary(reg_mehp)
...
reg_melb = lmer(resp~pc+urb+ed+medct+fem+blk+his+unemp+poll+pov+hobed+mcare+obese+tob+spec + (1+pc| county)+ (1|time) ,
                data = panelloblk)
summary(reg_melb)
confint(reg_melb,method="Wald")

panelhiblk = panel[panel$blk>(-0.47508),]
reg_mehb = lmer(resp~pc+urb+ed+medct+fem+blk+his+unemp+poll+pov+hobed+mcare+obese+tob+spec + (1+pc| county)+ (1|time) ,
                data = panelhiblk)
summary(reg_mehb)
...
reg_melh = lmer(resp~pc+urb+ed+medct+fem+blk+his+unemp+poll+pov+hobed+mcare+obese+tob+spec + (1+pc| county)+ (1|time) ,
                data = panellohis)
summary(reg_melh)
confint(reg_melh,method="Wald")

panelhihis = panel[panel$his>(-0.38146),]
reg_mehh = lmer(resp~pc+urb+ed+medct+fem+blk+his+unemp+poll+pov+hobed+mcare+obese+tob+spec + (1|time) ,
                data = panelhihis)
summary(reg_mehh)
